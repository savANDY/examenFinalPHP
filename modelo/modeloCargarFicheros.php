...
//   public function cargarClientes($nombre, $apellido, $telefono, $opcion){
//
//     if ($opcion = "I") {
//       $sql=("SELECT * FROM clientes WHERE (Nombre like '$nombre') AND (Apellidos like '$apellido') AND (telefono like '$telefono')");
//       print ($sql);
...
//
//
//       // $query="INSERT INTO clientes(Nombre,Apellido,Telefono) VALUES(?,?,?)";// ? sinboloak parametroa adierazten du
